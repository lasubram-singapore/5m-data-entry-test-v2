...
and which command moves a file from there into the next commit?
    ...
    Answer:This message tells you that there are modified files that haven't been added to the staging area yet, 
    so they won't be included in the next commit; running git add <filename> moves a file from "not staged" into staged, 
